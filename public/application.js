...
/***/ function(module, exports, __webpack_require__) {
	...
	var crudGearEvents = __webpack_require__(12);
	var crudProjectEvents = __webpack_require__(36);
	var notificationPupUps = __webpack_require__(43);
	var weather = __webpack_require__(44);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).then(function () {
	    api.signIn(signInData).then(function (response) {
	      store.user = response.user;
	      return store.user;
	    }).then(ui.signInSuccess).catch(ui.signUpFailure);
	  }).then(ui.success).catch(ui.signUpFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var gearEvents = __webpack_require__(12);
	var projectEvents = __webpack_require__(36);
...
/***/ function(module, exports, __webpack_require__) {
	...
	// Gets all the gear
	var onIndexGear = function onIndexGear() {
	  api.indexGear().then(ui.indexGearSuccess).catch(ui.indexGearFailure);
	};

	// Creates a new gear
	var onCreateGear = function onCreateGear(event) {
	  event.preventDefault();

	  var data = getFormFields(event.target);
	  api.createGear(data).then(ui.createGearSuccess).then(onIndexGear).catch(ui.createGearFailure);
	};

	// Updates a gear
	var onUpdateGear = function onUpdateGear(event) {
	  event.preventDefault();

	  var userInput = getFormFields(event.target);
	  var id = $(event.target).data('id');

	  api.updateGear(userInput, id).then(ui.updateGearSuccess(id)).then(onIndexGear).catch(ui.updateGearFailure);
	};

	// Deletes a gear
	var onDestroyGear = function onDestroyGear(event) {
	  event.preventDefault();

	  var id = $(event.target).data('id');

	  api.destroyGear(id).then(ui.destroyGearSuccess(id)).then(onIndexGear).catch(ui.destroyGearFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexGear = function indexGear() {
	  return $.ajax({
	...
	var showGear = function showGear(id) {
	  return $.ajax({
	...
	var createGear = function createGear(data) {
	  return $.ajax({
	    url: config.apiOrigin + '/my_gears',
	    method: 'POST',
	    headers: {
	...
	var updateGear = function updateGear(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/my_gears/' + id,
	    method: 'PATCH',
	    headers: {
	...
	var destroyGear = function destroyGear(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/my_gears/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexMyGearHandlerbars = __webpack_require__(15);
	var AddGearHandlerbars = __webpack_require__(35);

	var indexGearSuccess = function indexGearSuccess(data) {
	  // when user signs in, resources are automatically indexed.
	  var indexMyGearHtml = indexMyGearHandlerbars({
	...
	var createGearSuccess = function createGearSuccess() {
	  $.notify('Sweet gear 😎', 'success');
	};

	var createGearFailure = function createGearFailure() {
	  $.notify('Oh dear... something went wrong 😳', 'error');
	};

	var updateGearSuccess = function updateGearSuccess(id) {
	...
	var updateGearFailure = function updateGearFailure() {
	  $.notify('Oh dear... something went wrong 😳', 'error');
	};

	var destroyGearSuccess = function destroyGearSuccess(id) {
	...
	var destroyGearFailure = function destroyGearFailure() {
	  $.notify('Oh dear... something went wrong 😳', 'error');
	};

	module.exports = {
	  indexGearSuccess: indexGearSuccess,
	  createGearSuccess: createGearSuccess,
	  createGearFailure: createGearFailure,
	  updateGearSuccess: updateGearSuccess,
	  updateGearFailure: updateGearFailure,
	  destroyGearSuccess: destroyGearSuccess,
	  destroyGearFailure: destroyGearFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <h2>Gear</h2>\n\n  <table class=\"table\">\n    <thead>\n      <tr>\n        <th></th>\n        <th></th>\n        <th></th>\n        <th></th>\n      </tr>\n    </thead>\n    <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.my_gears : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </tbody>\n  </table>\n";
	  ...
	  return "        <tr data-id=\""
	    ...
	    + "</td>\n          <td><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#updateGearModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-edit\" aria-hidden=\"true\"></span></button>\n            <div id=\"updateGearModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"createGearModalLabel\">\n              <div class=\"modal-dialog modal-sm\" role=\"document\">\n                <div class=\"modal-content\">\n                  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                  <h4 class=\"modal-title\" id=\"createGearModalLabel\">Update Gear</h4>\n                  <br>\n                  <form class=\"update-gear\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                    <input class=\"clear-input modal-input\" type=\"text\" required onkeypress=\"return event.charCode >= 48 && event.charCode <= 57\" name=\"my_gear[quantity]\" data-char-limit=\"4\" maxlength=\"4\" value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1), depth0))
	    + "\" placeholder=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.quantity : stack1), depth0))
	    + "\">\n                    <input class=\"clear-input modal-input\" type=\"text\" required name=\"my_gear[name]\" data-char-limit=\"40\" maxlength=\"40\"  value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\" placeholder=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n                    <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn update-gear btn-primary\" name=\"submit\" value=\"Submit\">\n                  </form>\n                </div>\n              </div>\n            </div>\n          </td>\n          <td>\n            <button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#destroyGearModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span></button>\n            <div id=\"destroyGearModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"destroyGearModalLabel\">\n              <div class=\"modal-dialog modal-sm\" role=\"document\">\n                <div class=\"modal-content\">\n                  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                  <h4 class=\"modal-title\" id=\"destroyGearModalLabel\">Are you sure?</h4>\n                  <br>\n                  <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn destroy-gear btn-primary\" name=\"submit\" value=\"Do it!\">\n                </div>\n              </div>\n            </div>\n          </td>\n        </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.my_gears : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form class=\"create-gear\">\n  <input class=\"clear-input create-id\" type=\"text\" required onkeypress=\"return event.charCode >= 48 && event.charCode <= 57\" name=\"my_gear[quantity]\" data-char-limit=\"4\" maxlength=\"4\" value=\"\" placeholder=\"Quantity\">\n  <input class=\"clear-input\" type=\"text\" required name=\"my_gear[name]\" data-char-limit=\"60\" maxlength=\"60\" value=\"\" placeholder=\"Name\">\n  <input class=\"btn btn-success\" type=\"submit\" name=\"submit\" value=\"Submit\">\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onIndexProject = function onIndexProject() {
	  api.indexProject().then(ui.indexProjectSuccess).catch(ui.indexProjectFailure);
	};

	// Creates a new project
	var onCreateProject = function onCreateProject(event) {
	  event.preventDefault();

	  var data = getFormFields(event.target);
	  api.createProject(data).then(ui.createProjectSuccess).then(onIndexProject).catch(ui.createProjectFailure);
	};
	...
	var onUpdateProject = function onUpdateProject(event) {
	  ...
	  api.updateProject(userInput, id).then(ui.updateProjectSuccess(id)).then(onIndexProject).catch(ui.updateProjectFailure);
	};

	// Deletes a project
	var onDestroyProject = function onDestroyProject(event) {
	  event.preventDefault();

	  var id = $(event.target).data('id');

	  api.destroyProject(id).then(ui.destroyProjectSuccess(id)).then(onIndexProject).catch(ui.destroyProjectFailure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexProject = function indexProject() {
	  return $.ajax({
	...
	var showProject = function showProject(id) {
	  return $.ajax({
	...
	var updateProject = function updateProject(data, id) {
	  return $.ajax({
	    url: config.apiOrigin + '/projects/' + id,
	    method: 'PATCH',
	    headers: {
	...
	var destroyProject = function destroyProject(id) {
	  return $.ajax({
	    url: config.apiOrigin + '/projects/' + id,
	    method: 'DELETE',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var indexProjectsHandlerbars = __webpack_require__(39);
	var indexWeatherHandlerbars = __webpack_require__(40);
	var AddProjectHandlerbars = __webpack_require__(41);

	var indexProjectSuccess = function indexProjectSuccess(data) {
	  // when user signs in, her resources are automatically indexed.
	  var indexProjectsHtml = indexProjectsHandlerbars({
	    projects: data.projects
	  });
	  $('.project-table').html(indexProjectsHtml);
	  var indexWeatherHtml = indexWeatherHandlerbars({
	    projects: data.projects
	  });
	...
	var createProjectSuccess = function createProjectSuccess() {
	  $.notify('Added !', 'success');
	};

	var createProjectFailure = function createProjectFailure() {
	  $.notify('Oh dear... something went wrong 😳', 'error');
	};

	var updateProjectSuccess = function updateProjectSuccess(id) {
	  // without these two lines, modal does not fully dissapears and blocks user from
	  // further interactions with window.
	...
	var updateProjectFailure = function updateProjectFailure() {
	  $.notify('Oh dear... something went wrong 😳', 'error');
	};

	var destroyProjectSuccess = function destroyProjectSuccess(id) {
	  $.notify('Deleted', 'success');
	...
	var destroyProjectFailure = function destroyProjectFailure() {
	  $.notify('Oh dear... something went wrong 😳', 'error');
	};

	module.exports = {
	  indexProjectSuccess: indexProjectSuccess,
	  createProjectSuccess: createProjectSuccess,
	  createProjectFailure: createProjectFailure,
	  updateProjectSuccess: updateProjectSuccess,
	  updateProjectFailure: updateProjectFailure,
	  destroyProjectSuccess: destroyProjectSuccess,
	  destroyProjectFailure: destroyProjectFailure
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "  <h2>Projects</h2>\n\n  <table class=\"table\">\n    <thead>\n      <tr>\n        <th></th>\n        <th></th>\n        <th></th>\n        <th></th>\n      </tr>\n    </thead>\n    <tbody>\n"
	    + ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.projects : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "")
	    + "    </tbody>\n  </table>\n";
	},"2":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1, alias1=container.lambda, alias2=container.escapeExpression;
	  ...
	  return "        <tr data-id=\""
	    ...
	    + "</td>\n          <td><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#updateProjectModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-edit\" aria-hidden=\"true\"></span></button>\n            <div id=\"updateProjectModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"createProjectModalLabel\">\n              <div class=\"modal-dialog modal-sm\" role=\"document\">\n                <div class=\"modal-content\">\n                  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                  <h4 class=\"modal-title\" id=\"createProjectModalLabel\">Update Project</h4>\n                  <br>\n                  <form class=\"update-project\" data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">\n                    <input class=\"clear-input modal-input\" type=\"text\" required name=\"project[comment]\" data-char-limit=\"200\" maxlength=\"200\"  value=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.comment : stack1), depth0))
	    + "\" placeholder=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.comment : stack1), depth0))
	    + "\">\n                    <button type=\"button\" class=\"btn btn-default\" data-dismiss=\"modal\">Close</button>\n                    <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn update-project btn-primary\" name=\"submit\" value=\"Submit\">\n                  </form>\n                </div>\n              </div>\n            </div>\n          </td>\n          <td><button data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" class=\"btn btn-primary btn-sm\" data-toggle=\"modal\" data-target=\"#destroyProjectModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\"><span class=\"glyphicon glyphicon-trash\" aria-hidden=\"true\"></span></button>\n            <div id=\"destroyProjectModal"
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"modal fade\" tabindex=\"-1\" role=\"dialog\" aria-labelledby=\"destroyProjectModalLabel\">\n              <div class=\"modal-dialog modal-sm\" role=\"document\">\n                <div class=\"modal-content\">\n                  <button type=\"button\" class=\"close\" data-dismiss=\"modal\" aria-label=\"Close\"><span aria-hidden=\"true\">&times;</span></button>\n                  <h4 class=\"modal-title\" id=\"destroyProjectModalLabel\">Are you sure?</h4>\n                  <br>\n                  <input data-id=\""
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn destroy-project btn-primary\" name=\"submit\" value=\"Do it!\">\n                </div>\n              </div>\n            </div>\n          </td>\n        </tr>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.projects : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
	},"useData":true,"useBlockParams":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	    return "\n  <h2>Weather</h2>\n\n  <table class=\"table\">\n    <thead>\n      <tr>\n        <th></th>\n      </tr>\n    </thead>\n  </table>\n  <div class=\"weather-box\">\n    <input type=text class=\"weather-input-search\" placeholder=\"Search weather by city\">\n    <button class=\"btn btn-primary btn-md search-button\">Search</button>\n  </div>\n\n  <br>\n\n  <div class=\"weather-api-response\">\n  </div>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;

	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.projects : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	function __default(obj) { return obj && (obj.__esModule ? obj["default"] : obj); }
	module.exports = (Handlebars["default"] || Handlebars).template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    return "<form class=\"create-project\">\n  <input class=\"clear-input create-id\" type=\"text\" required name=\"project[comment]\" data-char-limit=\"200\" maxlength=\"200\" value=\"\" placeholder=\"What's your project?\">\n  <input class=\"btn btn-success\" type=\"submit\" name=\"submit\" value=\"&ensp;&emsp;Submit&emsp;&ensp;\">\n</form>\n";
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return ((stack1 = helpers["if"].call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.my_gears : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
	},"useData":true});
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (e) {
	   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(2)], __WEBPACK_AMD_DEFINE_FACTORY__ = (e), __WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ? (__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__), __WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__)) : (typeof module === "undefined" ? "undefined" : _typeof(module)) == "object" && module.exports ? module.exports = function (t, n) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var searchWeatherApiByQuery = function searchWeatherApiByQuery() {
	  var searchText = $('.weather-input-search').val();
	  var data = {
	    search: {
	      query: searchText
	    }
	  ...
	  $.ajax({
	    ...
	    var searchResult = '<br><h3>' + results.name + '</h3> <p>' + '<img src="http://openweathermap.org/img/w/' + results.weather[0].icon + '.png"' + '</p> <p> Temp: ' + results.main.temp + '°F </p> <p> Cloudiness: ' + results.clouds.all + '% </p> <p> Wind: ' + results.wind.speed + 'mph </p><br>';
	...
	module.exports = {
	  searchWeatherApiByQuery: searchWeatherApiByQuery,
	  addHandlers: addHandlers
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
